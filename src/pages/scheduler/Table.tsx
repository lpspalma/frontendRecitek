...
const columns: readonly Column[] = [
    ...
    { id: 'companyName', label: 'Nome', minWidth: 200, align: 'right' },
    { id: 'contact', label: 'Contato', minWidth: 170, align: 'right' },
    { id: 'phone', label: 'Fone', minWidth: 170, align: 'right' },
    { id: 'orderStatus', label: 'Status', minWidth: 170, align: 'right' },
];
...
const rows = [
    createData('orderID', 'removalProcess', 'name', 'contact', 'name', 'status'),
